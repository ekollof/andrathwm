...
LIBS = ${XINERAMALIBS} ${RANDRLIBS} ${XSSLIBS} ${PANGOLIBS} ${SNILIBS} ${BACKEND_COMPOSITORLIBS} ${XCBLIBS}
...
ifeq ($(BACKEND),X11)
BACKEND_XINERAMAFLAGS = ${XINERAMAFLAGS}
BACKEND_RANDRFLAGS    = ${RANDRFLAGS}
BACKEND_XSSFLAGS      = ${XSSFLAGS}
BACKEND_SNIFLAGS      = ${SNIFLAGS}
BACKEND_COMPOSITORFLAGS = ${COMPOSITORFLAGS}
BACKEND_COMPOSITORLIBS  = ${COMPOSITORLIBS}
else
BACKEND_XINERAMAFLAGS =
BACKEND_RANDRFLAGS    =
BACKEND_XSSFLAGS      =
BACKEND_SNIFLAGS      =
BACKEND_COMPOSITORFLAGS =
BACKEND_COMPOSITORLIBS  =
endif

# flags
CPPFLAGS = -D_DEFAULT_SOURCE -D_BSD_SOURCE -D_XOPEN_SOURCE=700L -DVERSION=\"${VERSION}\" -DBACKEND_${BACKEND} ${BACKEND_XINERAMAFLAGS} ${BACKEND_RANDRFLAGS} ${BACKEND_XSSFLAGS} ${BACKEND_SNIFLAGS} ${BACKEND_COMPOSITORFLAGS}
