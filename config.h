...
/* The following are defined as true globals (non-static) so that dbus.c and
 * icon.c can reference them via extern declarations in awm.h.
 * They are defined ONCE in awm.c (which sets AWM_CONFIG_IMPL before including
 * config.h); all other translation units get extern declarations via awm.h. */
...
static const Key keys[] = {
	...
	{ MODKEY | XCB_MOD_MASK_SHIFT, XKB_KEY_Tab, switcher_show_prev,
	    { .i = 1 } },
	{ ALTKEY, XKB_KEY_Tab, switcher_show, { .i = 0 } },
	{ ALTKEY | XCB_MOD_MASK_SHIFT, XKB_KEY_Tab, switcher_show_prev,
	    { .i = 0 } },
